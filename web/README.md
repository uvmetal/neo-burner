...
This project leverages earlier work for the paper wallet [neo-paper](https://github.com/cityofzion/neo-paper) and [neo-burner](https://github.com/cityofzion/neo-burner).
